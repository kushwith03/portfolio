      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-base text-primary font-bold tracking-wide uppercase">Get in Touch</h2>
              <h3 className="mt-2 text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white">Let's work together</h3>
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                Have a project in mind or want to discuss a potential opportunity? I'm available for internships starting January 2026.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 p-4 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
                ...
                <div>
                  ...
                  <a href="mailto:kushwith03@gmail.com" className="text-lg font-semibold text-gray-900 dark:text-white hover:text-primary transition-colors">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full py-4 rounded-lg font-bold text-white shadow-lg transition-all transform hover:-translate-y-1 ${
                  status === 'success' ? 'bg-green-600 hover:bg-green-700' : 'bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary'
